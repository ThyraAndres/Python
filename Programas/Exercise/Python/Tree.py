...
#funcion sorted toma una lista de elementos y los ordena
d = {'a':10, 'c':2, 'b':40}
print("imprimimos {d} : ", d.items())
for k,v in d.items():
    print("valores: ", k,v)
print("funcion sorted: ", sorted(d.items()))
...
for k,v in d.items():
    tmp.append((v,k))
print("list(): ", tmp)
tmp = sorted(tmp, reverse=True) #reverse = True significa que se ordena en orden descendente
print("ordenamiento con sorted, reverse: ", tmp)

"""
# ejemplo de reduccion con sorted
